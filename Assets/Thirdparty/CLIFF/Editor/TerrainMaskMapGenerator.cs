...
{
    private const string SourcePath = "Assets/Thirdparty/CLIFF/Terrain/Textures/SplatTex.psd";
    private const string OutputFolder = "Assets/Thirdparty/CLIFF/Terrain/Textures/MaskMaps";
